    ...
    <div id="default-carousel" className="relative w-full" data-carousel="slide">
      <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div className=" text-white bg-transparent p-10 left-16 top-24 text-left w-[500px] absolute z-40 ">
                ...
                <button type="button" className="text-white mt-4 bg-slate-600 hover:bg-[#24292F]/90 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                  Shop now
                </button>
             </div>
      </div>
